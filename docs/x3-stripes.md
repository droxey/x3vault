...
> **Source:** [https://www.serpentine.com/posts/2026/x3-stripes](https://www.serpentine.com/posts/2026/x3-stripes)  
> **Device / Subject:** Xteink X3 e-reader (ESP32-C3, SSD1680 / GDEY029T94 electronic paper display)

---

10 September 2026 · 14 min · Bryan O'Sullivan
...
X3](https://crosspointreader.com/). Not only is it astonishingly tiny, I could immediately
install the delightful open-source
[CrossPoint](https://github.com/crosspoint-reader/crosspoint-reader) firmware. I was very
...
ImageGrey pixels presentNeighbouring pixels in different statesStripesFlat grey fieldyesnononeBlack-and-white dithernoyesnoneGrey dither, using either of two methodsyesyesyes
...
code for this lives in [freeink-sdk](https://github.com/Free-Ink/freeink-sdk), the hardware
...
the glass. A handful of interleaved clocks drive the gates, each opening every *n*th row for a
...
The driver change became [freeink-sdk#95](https://github.com/Free-Ink/freeink-sdk/pull/95). Both
...
to do*, provide major hints like use of FFTs and test patterns, quibble and steer around
